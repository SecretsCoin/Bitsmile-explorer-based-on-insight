...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\FuturePoints\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/FuturePoints/';
  if (isLinux) dataDir = process.env.HOME + '/.FuturePoints/';
}
...
var bitcoindConf = {
  ...
  user: process.env.BITCOIND_USER || 'abc',
  pass: process.env.BITCOIND_PASS || '123',
